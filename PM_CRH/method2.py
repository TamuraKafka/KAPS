...
def getaccuracy(truthfile, predict_truth, datatype):
    ...
    truthRet = ""
    for item in predict_truth.values():
        truthRet += str(item) + ","
    print(truthRet)
...
def PM_CRH2_Output(datafile, truthfile):
    startTime = time.time()
    ...
    # datafile = "../datasets/GoodReads_309t_23941w/Y2.csv"
    ...
    # truthfile = "../datasets/T.csv"
    # truthfile = "../datasets/GoodReads_309t_23941w/truth.csv"
