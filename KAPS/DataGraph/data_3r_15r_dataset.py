...
Douban_RMSE_KAPS = [0.9414094371163544, 0.8895591785049096, 0.9098816929588938, 0.9450652458758702, 0.9735109972757386, 0.9631251046734102, 0.954936657275371, 0.9675806574578207, 0.9854473465879046, 0.9662465975491626, 0.9619060305328745, 0.9550876421015759, 0.9562141829860934]
...
Log_Douban_RMSE_CTD = []
for val in Douban_RMSE_KAPS:
    Log_Douban_RMSE_KAPS.append(math.log(val))
...
#  画 真实指标
# plt.plot(DatasetSize,Douban_RMSE_KAPS,marker = 'o',color = 'r', label = 'KAPS')
...
#  画 对数化指标
plt.plot(DatasetSize,Log_Douban_RMSE_KAPS,marker = 'o',color = 'r', label = 'KAPS')
...
Douban_MAE_KAPS = [0.7464526509222578, 0.6946513094334246, 0.721252763880024, 0.7481620548650574, 0.7628660605959874, 0.7657879087715656, 0.7561291781529876, 0.7667146496846896, 0.7743807291346724, 0.763476426267721, 0.7602462024553821, 0.7620803315485999, 0.7643059874236837]
...
Log_Douban_MAE_LFCN = []
Log_Douban_MAE_CTD = []
for val in Douban_MAE_KAPS:
    Log_Douban_MAE_KAPS.append(math.log(val))
...
# 画 真实指标
# plt.plot(DatasetSize,Douban_MAE_KAPS, marker = 'o',color = 'r', label = 'KAPS')
...
#  画 对数化指标
plt.plot(DatasetSize,Log_Douban_MAE_KAPS,marker = 'o',color = 'r', label = 'KAPS')
...
GoodReads_RMSE_KAPS = [0.6591769078151984, 0.6846754110644023, 0.6038345036544089, 0.6072087877796629, 0.5483624018664239, 0.5779313232762178, 0.5052871176275671, 0.5150103679983572, 0.5075515206408928,0.5009596397587451, 0.5177094973478193, 0.5047625178081295, 0.48493793340512714]
...
for val in GoodReads_RMSE_KAPS:
    Log_GoodReads_RMSE_KAPS.append(math.log(val))
...
# 画 真实指标
# plt.plot(DatasetSize,GoodReads_RMSE_KAPS, marker = 'o',color = 'r', label = 'KAPS')
...
# 画 对数化指标
plt.plot(DatasetSize,Log_GoodReads_RMSE_KAPS, marker = 'o',color = 'r', label = 'KAPS')
...
GoodReads_MAE_KAPS = [0.5091172894924819, 0.5245054770210781, 0.4783699519303365, 0.47982394790476984, 0.4324067760761198, 0.4630517419575198, 0.40023863157140255, 0.4105251262712765, 0.40316483971774697,0.4083064101466439, 0.4218758572035236, 0.4026817498329264, 0.3892017172830876]
...
for val in GoodReads_MAE_KAPS:
    Log_GoodReads_MAE_KAPS.append(math.log(val))
...
# 画 真实指标
# plt.plot(DatasetSize,GoodReads_MAE_KAPS, marker = 'o',color = 'r', label = 'KAPS')
...
# 画 对数化指标
plt.plot(DatasetSize,Log_GoodReads_MAE_KAPS, marker = 'o',color = 'r', label = 'KAPS')
