...
def test_simple_experiment(experiment_name,
    ...
    for eval_name, eval_fn in eval_fn_dict.items():
        for dist_name, dist_fn in dist_fn_dict.items():
            ...
            exp.train(dem_iter=dem_iter, mas_iter=mas_iter, masX_iter=0)
            ...
            if task_type == 'categorical':
                ...
                score_fn = lambda x, y: abs(np.array(x) - np.array(y))
...
if __name__ == "__main__":
    ...
    task_name = "douban"
    task_type = "numerical"
    # # answer_file = "./data/snow_affect/anger.standardized.tsv"
    # # truth_file = "./data/snow_affect/rankings_simgold.csv"
    #
    # merge = False
    log_dir = ""
    # gold_file = ""
