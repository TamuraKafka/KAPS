...
from eval_functions import eval_f1, iou_score_multi, rmse, oks_score_multi, _oks_score, gleu, gleu2way, bleu, bleu2way
...
def simple_experiment(dataset_name, eval_fn, dist_fn, merge_fn):
    def factory():
        ...
        return expmnt
    return SimpleExperimentBase(dataset_name)
    # return factory
